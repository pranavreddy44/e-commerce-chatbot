...
# Global router variable - will be None if semantic router fails
semantic_router = None

def initialize_semantic_router():
    """Try to initialize semantic router, but don't fail if it doesn't work"""
    global semantic_router
    
    try:
        print("Attempting to initialize semantic router...")
        ...
        if result and hasattr(result, 'name'):
            ...
            print("⚠️ Semantic router created but test failed")
            return False
            
    except Exception as e:
        print(f"❌ Semantic router initialization failed: {e}")
        print("🔄 Will use keyword-based routing instead")
        return False
...
def route_query(query: str) -> str:
    ...
    if semantic_router is not None:
        try:
            ...
            print(f"⚠️ Semantic routing failed: {e}, using keyword fallback")
    
    # Use keyword-based routing as fallback
...
semantic_available = initialize_semantic_router()

if not semantic_available:
    print("📝 Using keyword-based routing only")
else:
    print("🎯 Hybrid routing available (semantic + keyword fallback)")
